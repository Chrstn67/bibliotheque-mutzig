...
function declineOutDirs(outDirRoot) {
    ...
    (0, filesystemPathHandling_1.assertPosixPath)(outDirRoot);
    const outDirClient = node_path_1.default.posix.join(outDirRoot, 'client');
    const outDirServer = node_path_1.default.posix.join(outDirRoot, 'server');
...
function getOutDirAbsolute(config) {
    ...
    if (!outDirIsAbsolutePath(outDir)) {
        ...
        outDir = node_path_1.default.posix.join(root, outDir);
    }
    return outDir;
}
