...
function validateUserConfig(configUserUnwrapped, prop, val) {
    if (prop === 'root') {
        ...
        (0, utils_1.assertUsage)((0, node_path_1.isAbsolute)(val), 'config.root should be an absolute path');
        ...
        val.forEach((val) => {
            ...
            (0, utils_1.assertUsage)((0, node_path_1.isAbsolute)(val), `[config.telefuncFiles] ${val} should be an absolute path`);
