...
function resolveTelefuncFilePath(telefuncFilePathAbsolute, appRootDir) {
    ...
    const path = node_path_1.posix.relative(appRootDir, telefuncFilePathAbsolute);
    (0, utils_1.assertPosixPath)(path);
    (0, utils_1.assertUsage)(!path.startsWith('../'), `The telefunc file ${telefuncFilePathAbsolute} doesn't live inside the root directory ${appRootDir} of your project. Either move your telefunc file inside the root, or change ${picocolors_1.default.cyan('config.root')} (https://telefunc.com/root).`);
