...
import { Awaitable, Get, UniversalHandler, UniversalMiddleware } from '@universal-middleware/core';
...
type NodeMiddleware<C extends Universal.Context = Universal.Context> = (req: DecoratedRequest<C>, res: DecoratedServerResponse, next?: (err?: unknown) => void) => void;
type NodeHandler<C extends Universal.Context = Universal.Context> = NodeMiddleware<C>;
/** Adapter options */
 ...
 */
declare function createHandler<T extends unknown[]>(handlerFactory: Get<T, UniversalHandler>, options?: NodeAdapterHandlerOptions): Get<T, NodeMiddleware>;
/**
 * Creates a middleware to be passed to Connect-style frameworks like Express
 */
declare function createMiddleware<T extends unknown[], InContext extends Universal.Context, OutContext extends Universal.Context>(middlewareFactory: Get<T, UniversalMiddleware<InContext, OutContext>>, options?: NodeAdapterMiddlewareOptions): Get<T, NodeMiddleware<OutContext>>;
